...
Use `--config-dir path/to/helix` to change the directory used for configuration,
languages, themes, and runtime files while keeping Helix's other data locations
unchanged.
